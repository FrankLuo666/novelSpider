...
public class NovelDownload implements INovelDownload {
    ...
    public String download(String url, Configuration config) {
        ...
        for (int i = 0; i < maxThreadSize; i++) {
            // i = 0 0-100,  1-100章
            // i = 1 100-200,  101-200章
            // i = 2 200-300,  201章-300章
            // i = 3 300-400,  301-400章
            // ...
            // i = 19 1900-2000,  1901-2000章
            // i = 20 2000-2053,  2001-2053章
            // 总共才2053章
            int fromIndex = i * (config.getSize());
            int toIndex = i == maxThreadSize - 1 ? chapters.size() : (i + 1) * (config.getSize());
            downloadTaskAlloc.put(fromIndex+1 + "-" + toIndex, chapters.subList(fromIndex, toIndex));
        }
